 ...
 * @author prof_tes_a
 */
public class RopMaeRop_01 extends javax.swing.JDialog
{
    private boolean blnAce;
    private Vector<String> vecMar, vecImgMar;

    /**
     * Creates new form RopMaeRop_01
     */
    public RopMaeRop_01(java.awt.Frame parent, boolean modal)
    {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        lblImgMar.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RopMaeRop_01.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                RopMaeRop_01 dialog = new RopMaeRop_01(new javax.swing.JFrame(), true);
    ...
    private boolean cargarMarcas()
    {
        ...
        try
        {
            java.io.FileReader objFilRea=new java.io.FileReader("RopMarcas.txt");
    ...
    private boolean cargarImagenesMarcas()
    {
        ...
        try
        {
            java.io.FileReader objFilRea=new java.io.FileReader("RopImagenesMarcas.txt");
            java.io.BufferedReader objBufRea=new java.io.BufferedReader(objFilRea);
            String strLin;
